            ...
            <div class="row"> 
              <div class="col-md-4">
                ...
                <div class="form-group{{ $errors->has('question') ? ' has-error' : '' }}">                  
                  ...
                  {!! Form::textarea('question', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Question', 'rows'=>'6', 'required' => 'required']) !!}
                ...
                <div class="form-group{{ $errors->has('mark') ? ' has-error' : '' }}">
                    ...
                    <span class="required">*</span>
                    {!! Form::text('mark', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Mark', 'required' => 'required']) !!}
