...
class AllReportController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $uniqueuseranswer = Answer::where('topic_id', $topic->id)->groupBy('user_id')->distinct()->get();
        ...
        return view('admin.all_reports.show', compact('filtStudents', 'answers', 'uniqueuseranswer', 'c_que', 'topic'));
    }
