...
Route::group(['middleware'=>'auth'], function()
{
  ...
  Route::view('/home/quiz/{topic_id}/{path?}', 'home');
  Route::view('/home/quiz/result', 'home');
  Route::resource('/api/questionList', 'API\QuestionsController');
  Route::post('/api/clearResponse', 'API\QuestionsController@clearResponse');
  Route::post('/api/updateCountdown', 'API\QuestionsController@update_timer');
  Route::post('/api/updateResult', 'API\QuestionsController@update_result');
...
//   $auth = Auth::user();
//   $topic = Topic::findOrFail($id);
//   $questions = Question::where('topic_id', $id)->limit(20)->get();
